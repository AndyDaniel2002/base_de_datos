...
public class EliminarConductor extends JFrame {
	 ...
	 */
	public EliminarConductor(final Principal p) throws ParseException {
		...
		JLabel lblNewLabel = new JLabel("Lista de Choferes");
		...
		btnmcnEliminar.setBounds(22, 492, 103, 36);
		...
		btnmcnSalir.setText("Cancelar");
		btnmcnSalir.setFont(new Font("Tahoma", Font.BOLD, 13));
		btnmcnSalir.setBounds(1158, 492, 103, 36);
