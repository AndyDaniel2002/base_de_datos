...
public class ListadoDeTuristas extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public ListadoDeTuristas(final Principal p) throws ParseException {
		...
		JLabel lblNewLabel = new JLabel("Lista de Turistas");
		...
		model.addColumn("Cantidad de autos usados");
		model.addColumn("Importe total de los alquileres del turista");
