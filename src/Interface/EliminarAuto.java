...
public class EliminarAuto extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public EliminarAuto(final Principal p) throws ParseException {
		...
		JLabel lblNewLabel = new JLabel("Lista de Autos");
		...
		final BotonAnimacion btnmcnEliminar = new BotonAnimacion();
		btnmcnEliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			}
		});
		btnmcnEliminar.addMouseListener(new MouseAdapter() {
		...
		btnmcnEliminar.setEnabled(false);
		btnmcnEliminar.setFont(new Font("Tahoma", Font.BOLD, 13));
		btnmcnEliminar.setText("Eliminar");
		btnmcnEliminar.setBounds(22, 491, 87, 38);
		contentPane.add(btnmcnEliminar);
		...
		btnmcnCancelar.setBounds(1174, 491, 87, 38);
		...
		for(int i=0; i<table.getColumnModel().getColumnCount();i++){
		 ...
		 table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
	            public void valueChanged(ListSelectionEvent e) {
	                ...
	                if(selectedRow!=-1){
	            	 btnmcnEliminar.setEnabled(true);
	                }
	                }
	        });
