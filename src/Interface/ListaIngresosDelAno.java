...
public class ListaIngresosDelAno extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public ListaIngresosDelAno(final Principal p) throws ParseException {
		...
		JLabel lblNewLabel = new JLabel("Lista de Ingresos del A\u00F1o");
