...
public class ListadoDeContratos extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public ListadoDeContratos(final Principal p) throws ParseException {
		...
		model.addColumn("Nombre del turista");
		model.addColumn("Placa");
		model.addColumn("Marca");
		model.addColumn("Modelo");
		model.addColumn("Forma de pago");
		model.addColumn("Fecha inicio del contrato");
		model.addColumn("Fecha fin del contrato");
		model.addColumn("Pr�rroga");
		model.addColumn("Alquiler de chofer");
