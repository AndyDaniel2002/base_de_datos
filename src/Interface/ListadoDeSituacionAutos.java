...
public class ListadoDeSituacionAutos extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public ListadoDeSituacionAutos(final Principal p) throws ParseException {
		...
		JLabel lblNewLabel = new JLabel("Lista de Situaci\u00F3n de los Autos");
