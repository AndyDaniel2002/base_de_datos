...
public class ListaContratosPorPaises extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public ListaContratosPorPaises(final Principal p) throws ParseException {
		...
		JLabel lblNewLabel = new JLabel("Lista de Contratos por Pa\u00EDses");
		lblNewLabel.setBounds(454, 13, 324, 35);
		...
		model.addColumn("Cantidad de días alquilados");
		model.addColumn("Cantidad de días de prórroga");
		model.addColumn("Valor total en efectivo");
		model.addColumn("Valor total general");
