...
public class ListadoTuristasIncumplidores extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public ListadoTuristasIncumplidores(final Principal p) throws ParseException {
		...
		JLabel lblNewLabel = new JLabel("Lista de Turistas Incumplidores");
		...
		model.addColumn("Fecha fin de contrato");
		model.addColumn("Fecha entrega del auto");
