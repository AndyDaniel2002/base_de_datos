...
public class ListadoDeChoferes extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public ListadoDeChoferes(final Principal p) throws ParseException {
		...
		model.addColumn("Cantidad de carros manejados");
		...
		botonAnimacion.setBounds(1158, 490, 103, 36);
